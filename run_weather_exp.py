"""Run non-pretrain Weather experiments listed in weather_exp.md and log output."""
...
def main():
    ...
    parser.add_argument("--md", default="weather_exp.md", help="Markdown file with commands.")
    ...
    log_path = log_dir / f"weather_exp_run_{timestamp}.log"
