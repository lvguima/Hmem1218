"""Run Flotation experiments listed in flotation_exp.md and log output."""
...
def main():
    ...
    parser.add_argument("--md", default="flotation_exp.md", help="Markdown file with commands.")
    ...
    log_path = log_dir / f"flotation_exp_run_{timestamp}.log"
