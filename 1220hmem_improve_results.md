...
### P7 Results (Horizon Mask)

ETTm1
- horizon_mask=False (adaptive): MSE=0.772021  MAE=0.559702  RMSE=0.878647
- horizon_mask=True (exp):      MSE=0.724716  MAE=0.544504  RMSE=0.851303

Weather
- horizon_mask=False (adaptive): MSE=1.944069  MAE=0.826229  RMSE=1.394299
- horizon_mask=True (exp):       MSE=1.526640  MAE=0.699378  RMSE=1.235573

### P8 Results (Time Buckets)

ETTm1
- chrc_use_buckets=True, bucket_num=4: MSE=0.709707  MAE=0.534993  RMSE=0.842441

Weather
- chrc_use_buckets=True, bucket_num=4: MSE=1.584473  MAE=0.705362  RMSE=1.258759
